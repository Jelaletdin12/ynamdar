...
const LoginModal = ({ isVisible: propIsVisible, onClose: propOnClose }) => {
  ...
  const [verifyToken, { isLoading: isVerifyLoading }] = useVerifyTokenMutation();
    ...
    <>
      ...
      >
        ...
        <div className={styles.inputGroup}>
          <label>{activeTab === "phone" ? t("profile.telephone") : t("profile.email")}</label>
          {activeTab === "phone" ? (
            <Input
              ref={phoneInputRef}
              value={phone}
        ...
        >
          ...
          {isLoginLoading || isRegisterLoading ? 
            t("common.processing") : 
            isLogin ? t("profile.login") : t("profile.register")
          }
        </button>
